...
The repository is intended to be checked out (or symlinked) at `vendor/macwsa` in an
Android 16 AOSP tree. The product inherits the official arm64 goldfish emulator product,
adds only `MacWsaAgent`, and does not patch framework, SurfaceFlinger, WindowManager, or
the kernel.
